...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto py-0">
                    ...
                    <a href="blog.php" class="nav-item nav-link active px-3" style="font-weight: bold; margin-right: 5px;">Blog</a>
    ...
    <div class="container-fluid text-center">
        <img src="Blog_imgs/banner1.png" alt="banner" style="width: 70%; margin-top: 5%;" class="rounded">
    </div>
    <!-- Banner End -->
    ...
    <div class="container-fluid blog py-5">
        <div class="container py-5">
            <h3 class="text-center" style="font-size: 50px; margin-bottom:5%;">Variety of Plastic</h3>
            <div class="row g-4 justify-content-center">
                <div class="col-lg-6 col-xl-4 wow fadeInUp" data-wow-delay="0.6s">
                    <?php
                    $query1 = "SELECT * FROM `blog` WHERE `id` = '1'";
                    $validate2 = mysqli_query($connection, $query1);
                    while ($show = mysqli_fetch_assoc($validate2)) {
                    ?>
                        <div class="product-item">
                            <div class="product-img">
                                <?php $imagepath = "Admin Panel/blog_upload_img/" . $show['file_name'] ?>
                                <img src="<?php echo $imagepath; ?>" class="img-fluid rounded-top w-100" alt="">
                            </div>
                            <div class="product-content rounded-bottom p-4">
                                <a href="#" class="h4 d-inline-block mb-3"><?php echo $show['title'] ?></a>
                ...
                <div class="col-lg-6 col-xl-4 wow fadeInUp" data-wow-delay="0.6s">
                    <?php
                    $query1 = "SELECT * FROM `blog` WHERE `id` = '2'";
                    $validate2 = mysqli_query($connection, $query1);
                    while ($show = mysqli_fetch_assoc($validate2)) {
                    ?>
                        <div class="product-item">
                ...
                <div class="col-lg-6 col-xl-4 wow fadeInUp" data-wow-delay="0.6s">
                    <?php
                    $query1 = "SELECT * FROM `blog` WHERE `id` = '3'";
                    $validate2 = mysqli_query($connection, $query1);
                    while ($show = mysqli_fetch_assoc($validate2)) {
                    ?>
                        <div class="product-item">
    ...
    <div class="container-fluid text-center">
        <h4 class="text-center" style="font-size: 60px;margin:0px;margin-bottom:4%;"> Special Offer </h4>
        <img src="Blog_imgs/banner2.png" alt="banner" style="width: 70%; margin-bottom: 2%;" class="rounded">
    </div>
    <!-- Banner End -->
