                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header bg-info">
                                <h4 class="text-center">Edit Data & Image</h4>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                $id = $_GET['id'];
                                $query = "SELECT * FROM product_jar_upload WHERE id= '$id' ";
                                $query_run = mysqli_query($connection, $query);

                                if (mysqli_num_rows($query_run) > 0) {
                                    foreach ($query_run as $row) {
                                ?>
                                        <form action="jars_admin_code.php" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="text-center">
                                                <img src="<?php echo "jars_upload_img/" . $row['file_name']; ?>" alt="Updated Image" width="400px" class="img-fluid mt-5 mb-5">
                                            </div>
