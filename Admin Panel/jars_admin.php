    ...
    <div class="container-fluid position-relative bg-white d-flex p-0">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="jars_admin.php" class="dropdown-item active">Jars</a>
                        </div>
                    </div>
                    <div class="nav-item dropdown">
        ...
        <div class="content">
            ...
            <div class="container-fluid text-center" style="margin-top: 4%;">
                <a href="jars_admin_upload.php" class="btn btn-primary w-100 rounded-pill" style="font-size: 20px; font-weight:bold; ">Click Here to Upload Data</a>
            </div>
                        ...
                        <div class="card">
                            <div class="card">
                                <div class="card-header text-white">
                                    <h4 class="text-dark text-center mt-3">Available Jars</h4>
                                </div>
                                <div class="card-body">
                                    ...
                                    <?php
                                    $query = "SELECT * FROM product_jar_upload";
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <img src="<?php echo "jars_upload_img/" . $row['file_name']; ?>" width="100px" alt="IMG" class="rounded">

                                                            </td>
                                                            <td>
                                                                <a href="jars_admin_edit.php?id=<?php echo $row['id']; ?>" class="btn btn-danger rounded-pill">EDIT</a>
                                                            </td>
                                                            <td>
                                                                <form action="jars_admin_code.php" method="POST" class="d-inline">
