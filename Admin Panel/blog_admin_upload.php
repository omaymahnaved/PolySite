...
if (isset($_POST['save_stud_image'])) {
    ...
    if (empty($errors) == true) {
        move_uploaded_file($file_tmp, "blog_upload_img/" . $file_name);
        $query = "INSERT INTO `blog`(`id`,`file_name`,`title`,`description`) VALUES ('$id','$file_name','$title','$description')";
                            ...
                            <div class="card-body">
                                ...
                                <form action="" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group mt-4">
                                        <input type="file" name="file_name" accept="jpg,png,jpeg" class="form-control rounded-pill" required>
                                    </div>
                                    <div class="form-group mt-4">
                                        <label for="">Id</label>
