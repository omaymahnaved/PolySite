    ...
    <div class="container-fluid position-relative bg-white d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="blog_admin.php" class="nav-item nav-link active"><i class="fab fa-blogger-b me-2"></i>Blog</a>
        ...
        <div class="content">
            ...
            <div class="container-fluid text-center" style="margin-top: 4%;">
                <a href="blog_admin_upload.php" class="btn btn-primary w-100 rounded-pill" style="font-size: 20px; font-weight:bold; ">Click Here to Upload Data</a>
            </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header text-white">
                                <h4 class="text-dark text-center mt-3">Blog</h4>
                                <h6 class="text-dark text-center mt-3">(Only Upload Till Id 3)</h6>
                            </div>
                            <div class="card-body">
                                <?php
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <img src="<?php echo "blog_upload_img/" . $row['file_name']; ?>" width="100px" alt="IMG" class="rounded">
                                                        </td>
                                                        <td>
                                                            <a href="blog_admin_edit.php?id=<?php echo $row['id']; ?>" class="btn btn-danger rounded-pill">EDIT</a>
                                                        </td>
                                                        <td>
                                                            <form action="blog_admin_code.php" method="POST" class="d-inline">
