...
if (isset($_POST['submit'])) {
    ...
    $queryinsert = "INSERT INTO `feature`(`id`,`title`, `description`) VALUES ('$id','$title','$description')";
                            ...
                            <div class="card-body">
                                ...
                                <form action="" method="POST" enctype="multipart/form-data">
                                    <div class="form-group mt-4">
                                        <label for="">Id</label>
                                        <input type="tel" class="form-control rounded-pill" id="" name="id">
                                    </div>
                                    <div class="form-group mt-4">
                                        <label for="">Title</label>
                                        <input type="text" class="form-control rounded-pill" id="" name="title">
                                    </div>
                                    <div class="form-group mt-4">
                                        <label for="">Description</label>
                                        <input type="text" class="form-control rounded-pill" id="" name="description">
                                    </div>
