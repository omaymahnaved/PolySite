                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <?php
                                $id = $_GET['id'];
                                $query = "SELECT * FROM product_bottle_upload WHERE id= '$id' ";
                                ...
                                ?>
                                        ...
                                        <form action="bottles_admin_code.php" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="text-center">
                                                <img src="<?php echo "bottles_upload_img/" . $row['file_name']; ?>" alt="Updated Image" width="400px" class="img-fluid mt-5 mb-5 rounded">
                                            </div>
