                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="text-center mt-3">Edit Data & Image</h4>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                ?>
                                        <form action="blog_admin_code.php" method="POST" enctype="multipart/form-data">
                                            <input type="hidden" name="id" value="<?php echo $row['id']; ?>" />
                                            <div class="form-group mt-4">
                                                <input type="file" name="file_name" class="form-control rounded-pill" required>
                                                <input type="hidden" name="stud_image_old" value="<?php echo $row['file_name']; ?>">
                                            </div>
                                            <div class="text-center">
                                                <img src="<?php echo "blog_upload_img/" . $row['file_name']; ?>" alt="Updated Image" class="img-fluid mt-5 mb-5 rounded">
                                            </div>
                                            <div class="form-group text-center">
                                                <button type="submit" name="update_stud_image" class="btn btn-primary w-100 rounded-pill" style="font-size: 20px; font-weight: bold;">UPDATE</button>
                                            </div>
                                        </form>
                                <?php
                                    }
