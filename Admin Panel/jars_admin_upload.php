                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form action="jars_admin_code.php" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group mt-4">
                                        <label for="">Id</label>
                                        <input type="text" class="form-control rounded-pill" id="" name="j_id">
                                    </div>
                                    <div class="form-group mt-4">
                                        <label for="">Title</label>
                                        <input type="text" class="form-control rounded-pill" id="" name="j_title">
                                    </div>
                                    <div class="form-group mt-4">
                                        <label for="">Description</label>
                                        <input type="text" class="form-control rounded-pill" id="" name="j_description">
                                    </div>
                                    <div class="form-group mt-4">
                                        <label for="">Price</label>
                                        <input type="text" class="form-control rounded-pill" id="" name="j_price">
                                    </div>
