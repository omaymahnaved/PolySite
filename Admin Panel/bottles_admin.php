    ...
    <div class="container-fluid position-relative bg-white d-flex p-0">
            ...
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link active dropdown-toggle" data-bs-toggle="dropdown"><i class="fas fa-box-open me-2"></i>Products</a>
        ...
        <div class="content">
            ...
            <div class="container-fluid text-center" style="margin-top: 4%;">
                <a href="bottles_admin_upload.php" class="btn btn-primary w-100 rounded-pill" style="font-size: 20px; font-weight:bold; ">Click Here to Upload Data</a>
            </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header text-white">
                                <h4 class="text-dark text-center mt-3">Available Bottles</h4>
                                <h6 class="text-dark text-center mt-3">(Only Upload Till Id 6)</h6>
                            </div>
                            <div class="card-body">
                                ...
                                ?>
                                <?php
                                $query = "SELECT * FROM product_bottle_upload";
                                    ...
                                    <table class="table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="color:black; font-size: 21px;">Price</th>
                                                <th style="color:black; font-size: 21px;">Image</th>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <img src="<?php echo "bottles_upload_img/" . $row['file_name']; ?>" width="100px" alt="IMG" class="rounded">
                                                        </td>
                                                        <td>
                                                            <a href="bottles_admin_edit.php?id=<?php echo $row['id']; ?>" class="btn btn-danger rounded-pill">EDIT</a>
                                                        </td>
                                                        <td>
                                                            <form action="bottles_admin_code.php" method="POST" class="d-inline">
                                                                <input type="hidden" name="delete_id" value="<?php echo $row['id']; ?>">
                                                                <input type="hidden" name="del_stud_image" value="<?php echo $row['file_name']; ?>">
