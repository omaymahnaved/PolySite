        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto py-0">
                    ...
                    <a href="gallery.php" class="nav-item nav-link active px-3" style="font-weight: bold; margin-right: 5px;">Gallery</a>
...
<div class="container-fluid blog py-5">
    <div class="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.2s" style="max-width: 800px;">
        <h4 class="text-uppercase text-primary">Gallery Of Tomorrow's plastic Innovations</h4>
        ...
        <div class="col-md-4 wow fadeInUp" data-wow-delay="0.6s">
            ...
            ?>
                <div class="product-item">
                    ...
                    <div class="row g-4 justify-content-center">
                        <div class="col-6">
                            <a href="galleryimgs/b45.png" class="btn btn-dark mt-2 w-100 rounded-pill" download="pet bottle">download</a>
                            <a href="petbottle.pdf" class="btn btn-dark mt-2 mb-3 w-100 rounded-pill">details</a>
                        </div>
                    </div>
                </div>
            <?PHP } ?>
...
<div class="container-fluid blog py-5">
    <div class="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.2s" style="max-width: 800px;">
        <h1 class="display-3 text-capitalize mb-3">Jars</h1>
    </div>
    <div class="row g-4 justify-content-center">
        <div class="col-md-4 wow fadeInUp" data-wow-delay="0.6s">
            <?php
            $query1 = "SELECT * FROM `product_jar_upload` WHERE `id` = '1'";
            $validate2 = mysqli_query($connection, $query1);
            while ($show = mysqli_fetch_assoc($validate2)) {
            ?>
                <div class="product-item">
                    <div class="product-img">
                        <?php $imagepath = "Admin Panel/jars_upload_img/" . $show['file_name'] ?>
                        <img src="<?php echo $imagepath; ?>" class="img-fluid rounded-top w-100" alt="">
                    </div>
                    <div class="row g-4 justify-content-center">
                        <div class="col-6">
                            <a href="galleryimgs/b45.png" class="btn btn-dark mt-2 w-100 rounded-pill" download="pet bottle">download</a>
                            <a href="petjar.pdf" class="btn btn-dark mt-2 mb-3 w-100 rounded-pill">details</a>
                        </div>
                    </div>
                </div>
            <?PHP } ?>
        ...
        <div class="col-md-4 wow fadeInUp" data-wow-delay="0.6s">
            <?php
            $query1 = "SELECT * FROM `product_jar_upload` WHERE `id` = '2'";
            $validate2 = mysqli_query($connection, $query1);
            while ($show = mysqli_fetch_assoc($validate2)) {
            ?>
                <div class="product-item">
        ...
        <div class="col-md-4 wow fadeInUp" data-wow-delay="0.6s">
            <?php
            $query1 = "SELECT * FROM `product_jar_upload` WHERE `id` = '3'";
            $validate2 = mysqli_query($connection, $query1);
            while ($show = mysqli_fetch_assoc($validate2)) {
            ?>
                <div class="product-item">
    ...
    <div class="row g-4 justify-content-center">
        <div class="col-md-4 wow fadeInUp" data-wow-delay="0.6s">
            <?php
            $query1 = "SELECT * FROM `product_jar_upload` WHERE `id` = '4'";
            $validate2 = mysqli_query($connection, $query1);
            while ($show = mysqli_fetch_assoc($validate2)) {
            ?>
                <div class="product-item">
        ...
        <div class="col-md-4 wow fadeInUp" data-wow-delay="0.6s">
            <?php
            $query1 = "SELECT * FROM `product_jar_upload` WHERE `id` = '5'";
            $validate2 = mysqli_query($connection, $query1);
            while ($show = mysqli_fetch_assoc($validate2)) {
            ?>
                <div class="product-item">
        ...
        <div class="col-md-4 wow fadeInUp" data-wow-delay="0.6s">
            <?php
            $query1 = "SELECT * FROM `product_jar_upload` WHERE `id` = '6'";
            $validate2 = mysqli_query($connection, $query1);
            while ($show = mysqli_fetch_assoc($validate2)) {
            ?>
                <div class="product-item">
