...
if (isset($_POST['submit'])) {
    ...
    $queryinsert = "INSERT INTO `order_jars` (`name`, `email`, `product`, `amount`, `shipping_address`) VALUES ('$name','$email','$product','$amount','$shipping_address')";
    ...
    <div class="container-fluid bg-breadcrumb">
        <div class="container text-center py-5" style="max-width: 900px;">
            ...
            <ol class="breadcrumb d-flex justify-content-center mb-0 wow fadeInDown" data-wow-delay="0.3s">
                ...
                <li class="breadcrumb-item text-primary"><a href="bottles.php">Jars</a></li>
                            ...
                            <div class="col-lg-12 col-xl-12">
                                <div class="form-floating">
                                    <select class="form-select form-control bg-white border-0" aria-label=".form-select-sm example" name="product">
                                        ...
                                        <option>LG 3L JAR</option>
                                        <option>MD 2L JAR</option>
                                        <option>SM 1L JAR</option>
                                    </select>
