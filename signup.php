...
if (isset($_POST['submit'])) {
  ...
  if (mysqli_num_rows($result) > 0) {
    ...
    $queryinsert = "INSERT INTO `registeration`( `name`, `email`, `password`) VALUES ('$name','$email','$pass')";
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-dark">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                ...
                <a href="signup.php" class="btn btn-secondary rounded-pill d-inline-flex active flex-shrink-0 py-2 px-5">Login</a>
            </div>
        </div>
    </nav>
  <!-- Navbar & Hero End -->
      ...
      <div class="row g-5">
        <div class="col-lg-6 col-md-12 wow fadeInUp" data-wow-delay="0.2s">
          <div class="text-center mx-auto pb-5" style="max-width: 800px;">
            ...
            <h1 class="display-3 text-capitalize mb-3">Register Now</h1>
          </div>
          <form action="" method="POST" onsubmit="showAlert()">
            <div class="row g-4">
              ...
              <div class="col-12">
                <div class="form-floating">
                  <input type="password" class="form-control border-0" id="cpassword" placeholder="Confirm Password" name="cpassword">
