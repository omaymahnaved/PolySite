...
<body>
                ...
                <div class="navbar-nav ms-auto py-0">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu m-0">
                            ...
                            <a href="jars.php" class="dropdown-item active">Jars</a>
                        </div>
                    </div>
    ...
    <div class="container-fluid bg-breadcrumb">
        <div class="container text-center py-5" style="max-width: 900px;">
            ...
            <ol class="breadcrumb d-flex justify-content-center mb-0 wow fadeInDown" data-wow-delay="0.3s">
                ...
                <li class="breadcrumb-item active text-primary">Jars</li>
            </ol>
        </div>
    </div>
    <!-- Header End -->
    ...
    <div class="container-fluid text-center">
        <a href="jars_order.php" class="btn btn-secondary w-100 rounded-pill pt-3 pb-3" style="font-size: 20px; font-weight:bold; ">Order Now</a>
    </div><br><br>
